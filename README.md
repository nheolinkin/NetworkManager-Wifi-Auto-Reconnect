...
```bash
curl -o /tmp/99-wifi-reconnect.sh https://raw.githubusercontent.com/nheolinkin/Linux-Guides/main/99-wifi-reconnect.sh
```

Or clone the repo:

```bash
git clone https://github.com/nheolinkin/Linux-Guides.git
```
